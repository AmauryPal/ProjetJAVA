...
public class ControllerSaves {
	...
	public void switchToMain(ActionEvent event) throws IOException {
		...
		loadData("enCours", wichButton);
		controller.go(event);
		controller.afficher(controller.board, controller.joueur);
	}
	
	public void loadSave1(ActionEvent event) throws IOException {
		wichButton = 1;
		if(verifyDisponibility(wichButton, "enCours"))
			switchToMain(event);
	}
	...
	public static boolean verifyDisponibility(int wichButton, String where) {
